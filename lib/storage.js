...
//
// โครงสร้างไฟล์นี้ได้รับการอัปเกรดเพื่อรองรับ Use Cases ทั้งหมด 15+ เคส และเพิ่มฝ่ายซ่อมบำรุง (Maintenance)
...
const SEED_TEMPLATES = [
  ...
  // 11. ฝ่ายซ่อมบำรุง - การตรวจสภาพเครื่องจักร PM
  {
    id: "tmpl-maint-pm",
  ...
  // 12. ฝ่ายซ่อมบำรุง - การจัดการงานซ่อมตาม SLA
  {
    id: "tmpl-maint-sla",
...
const SEED_MAINT_BREAKDOWNS = [
  ...
  { machineId: "PUMP-05", name: "ปั๊มน้ำบ่อบำบัดแรงดัน", breakdownMinutes: 10, utilizationPercent: 92, type: "Pump" }
];

const SEED_SLA_REQUESTS = [
  { requestId: "RQ-1045", issue: "ระบบไฟฟ้าร้านชำรุด", priority: "High (SLA 2 ชม.)", minutesUsed: 180, met: "no" },
  { requestId: "RQ-1052", issue: "ท่อน้ำประปาแตก โซน A", priority: "High (SLA 2 ชม.)", minutesUsed: 95, met: "yes" }
];
