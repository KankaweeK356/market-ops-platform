...
// ข้อมูลจำลองเพิ่มเติมสำหรับหน้ารายงานผู้บริหาร (Case 1-6)
const SEED_ASSETS = [
  { id: "veh-01", departmentId: "d-security", type: "vehicle", name: "รถตรวจการณ์ กข-1234" }
];

const SEED_ZONE_REPORT_HISTORY = [
  { zone: "โซน C - อาหารทะเล", date: "2026-07-09", count: 3 },
  { zone: "โซน C - อาหารทะเล", date: "2026-07-10", count: 0 },
  { zone: "โซน C - อาหารทะเล", date: "2026-07-11", count: 0 },
  { zone: "โซน C - อาหารทะเล", date: "2026-07-12", count: 0 },
  { zone: "โซน C - อาหารทะเล", date: "2026-07-13", count: 0 },
  { zone: "โซน C - อาหารทะเล", date: "2026-07-14", count: 0 }
];
...
const SEED_REPAIR_BACKLOG = [
  { zone: "โซน A - ผักผลไม้", frequency: 5, severity: "สูง", affectedVendors: 12, score: 91 },
  { zone: "โซน D - ของแห้ง/เครื่องปรุง", frequency: 3, severity: "กลาง", affectedVendors: 20, score: 78 },
  { zone: "โซน B - เนื้อสัตว์", frequency: 4, severity: "สูง", affectedVendors: 6, score: 74 },
  { zone: "ลานจอดรถ/ทางเข้า", frequency: 2, severity: "ต่ำ", affectedVendors: 30, score: 55 },
  { zone: "โซน E - อาหารสำเร็จรูป", frequency: 1, severity: "กลาง", affectedVendors: 4, score: 40 }
];
