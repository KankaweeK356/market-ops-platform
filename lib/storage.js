...
const SEED_TEMPLATES = [
  // 1. จัดพื้นที่ - แผงเช่า
  {
    id: "tmpl-space-occupancy",
    activityId: "act-space-occupancy",
    questions: [
      { id: "stallOccupancyPercent", label: "อัตราเช่าแผงค้ารวมทุกโซน (%) - เป้าหมาย >= 90%", type: "number", required: true, flagIf: { value: "<90", setStatus: "ต้องติดตาม" } },
      { id: "activeStallsCount", label: "จำนวนแผงที่ผู้เช่าเปิดขายจริง (แผง)", type: "number", required: true }
    ]
  },
  // 2. จัดพื้นที่ - ตรวจสารพิษ
  {
    ...
    questions: [
      { id: "toxinPassPercent", label: "สัดส่วนตรวจสารเคมีแล้วปลอดภัย (%) - เป้าหมาย 100%", type: "number", required: true, flagIf: { value: "<100", setStatus: "ต้องติดตาม" } },
      { id: "testedSamples", label: "จำนวนผักผลไม้ตัวอย่างที่ส่งตรวจสุ่ม (รายการ)", type: "number", required: true }
    ]
  },
...
function generateSeedSubmissions() {
  ...
  return [
    // 1. ฝ่ายจัดพื้นที่ & สารพิษ
    {
      ...
      zone: ZONES[0],
      answers: [
        { questionId: "stallOccupancyPercent", label: "อัตราเช่าแผงค้ารวมทุกโซน (%) - เป้าหมาย >= 90%", value: 96 },
        { questionId: "activeStallsCount", label: "จำนวนแผงที่ผู้เช่าเปิดขายจริง (แผง)", value: 450 }
      ],
      derivedStatus: "ปกติ",
      createdAt: now - 1 * day
    },
    {
      ...
      zone: ZONES[0],
      answers: [
        { questionId: "toxinPassPercent", label: "สัดส่วนตรวจสารเคมีแล้วปลอดภัย (%) - เป้าหมาย 100%", value: 95 },
        { questionId: "testedSamples", label: "จำนวนผักผลไม้ตัวอย่างที่ส่งตรวจสุ่ม (รายการ)", value: 65 }
      ],
