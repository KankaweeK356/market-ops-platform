  ...
  return [
    {
      ...
      zone: ZONES[0],
      answers: [
        { questionId: "q-1", label: "กระดาษชำระพร้อมใช้", value: "yes" },
        { questionId: "q-2", label: "พื้นแห้งไม่ลื่น", value: "yes" },
        { questionId: "q-3", label: "ถังขยะไม่ล้น", value: "yes" },
        { questionId: "q-4", label: "มีกลิ่นไม่พึงประสงค์", value: "no" },
        { questionId: "q-5", label: "ภาพถ่ายสภาพห้องน้ำ", value: "" },
        { questionId: "q-6", label: "หมายเหตุ / จุดที่ต้องปรับปรุง", value: "ตรวจรอบเช้า สะอาดเรียบร้อยดีมาก" }
      ],
      derivedStatus: "ปกติ",
      createdAt: now - 1 * day
    },
    {
      ...
      answers: [
        ...
        { questionId: "q-2", label: "พื้นแห้งไม่ลื่น", value: "yes" },
        { questionId: "q-3", label: "ถังขยะไม่ล้น", value: "yes" },
        { questionId: "q-4", label: "มีกลิ่นไม่พึงประสงค์", value: "yes" },
        { questionId: "q-5", label: "ภาพถ่ายสภาพห้องน้ำ", value: "" },
        { questionId: "q-6", label: "หมายเหตุ / จุดที่ต้องปรับปรุง", value: "พบกลิ่นเหม็นจากท่อระบายน้ำล้น แจ้งฝ่ายซ่อมบำรุงแล้วรอดำเนินการ" }
      ],
